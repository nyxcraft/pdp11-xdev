# Shared build configuration, included as its first line by every tool
# Makefile (include ../common/config.mk).  Paths are relative to a tool
# directory (src/pdp11-<tool>/).
#
