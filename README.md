...
| `ultrix11v1` `ultrix11v2` | full | Ultrix-11 1.0 (= V7M-11 1.0, 1982/83) & 2.0 (1984): DEC's productized Version 7 for the PDP-11 and the root of the Ultrix line. The 3.1 `sysent.c` confirms the V7 core numbers (1–48) plus DEC/SysV additions (`msgsys`/`utssys`/`fcntl`/`ulimit`… at 49+), `0407`/`0410`/`0411` a.out — served by apsim's Ultrix personality. Compiler-validated like `v3` (1.0 has a SIMH image at `agn453/V7M-11`; 2.0 a native install tape, neither carved yet) |
